...
qrcode_timeout = function () { //二维码超时则停止显示二维码
    ...
    $("#show_qrcode").attr("src", 'http://ymcq.online/ymcq/pay/img/no.png');
...
show_desc = function (data) { //商品描述
    var html = '';
    html += data&&data.subject?getDescMode('商品', data.subject):'';
    html += getDescMode('金额', "￥" + data.price);
    html += getDescMode('订单号', data.order_id);
